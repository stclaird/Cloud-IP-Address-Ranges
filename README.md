...
I believe the ASN info could be less accurate as some hosts use ASNs from a parent company which they may share with more than one seperate entity/company. 
