# Cloud IP to DB
This project creates a SQLite database containing CIDR records from large and large-ish cloud or hosting provider platforms. Currently, the project imports IP CIDR networks from the following:
